classdef Climb < cast.mission.Segment
    ...
    methods
        function obj = Climb(StartAlt,EndAlt,Mach,ROC,CAS)
            arguments
                StartAlt
                EndAlt
                Mach
        ...
        function [alt,M,TAS] = ClimbProperties(obj);
            alt = unique([obj.StartAlt:500/cast.SI.ft:obj.EndAlt,obj.EndAlt]);
        ...
        function [r,t] = distanceEstimate(obj)
            delta_h = obj.EndAlt - obj.StartAlt;
            t = delta_h/obj.ROC;
            [alt,~,TAS] = obj.ClimbProperties();
