...
CD0 = cast.drag.baff2CD0(obj.Baff,obj.WingArea,obj.ADR.Alt_cruise,obj.ADR.M_c,"pLamFuselage",0.20,"pLamWing",0.40);
% CD0 = CD0 + CD0 * 0.015 + 0.035/obj.WingArea; % 10.2514/1.C036529 (near Eq. 5)
CD0 = CD0 + CD0*0.05;
% cruise info
[rho,a] = cast.util.atmos(obj.ADR.Alt_cruise);
e_c = obj.EstimateOswald(obj.ADR.M_c,"Schaufele");
...
e_to = obj.EstimateOswald(0.3,"Schaufele")-0.05;
...
e_ld = obj.EstimateOswald(0.3,"Schaufele")-0.1;
